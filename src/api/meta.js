...
export async function getAds(accountId, { since, until }) {
  ...
  return apiFetch(`/${accountId}/ads`, {
    fields: `name,status,creative{id,name,image_url,thumbnail_url,video_id,actor_id,body,title,call_to_action_type},insights.time_range(${timeRange}){${insightFields}}`,
    limit: '50',
